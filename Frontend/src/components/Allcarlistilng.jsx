        ...
        <Card className="border-blue-200/60 hover:border-blue-400 transition-all duration-300 hover:shadow-xl bg-white overflow-hidden group-hover:scale-[1.01] transform">
          <CardContent className="p-0">
            <div className="flex">
              ...
              <div className="relative w-80 h-48 flex-shrink-0 overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100">
                <img
                ...
                <div className="absolute top-3 left-3 flex flex-col gap-2">
                  {car.isFeatured && (
                    <Badge className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-semibold shadow-lg backdrop-blur-sm">
                      ⭐ Featured
                    </Badge>
                  )}
                  {car.isVerified && (
                    <Badge className="bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold shadow-lg backdrop-blur-sm">
                ...
                <button
                  ...
                  className={`absolute top-3 right-3 p-3 rounded-full backdrop-blur-md transition-all duration-300 transform hover:scale-110 ${
                    isFavorited
              ...
              {/* Content Section */}
              <div className="flex-1 p-6 bg-gradient-to-r from-white to-blue-50/30">
                ...
                <div className="grid grid-cols-4 gap-3 mb-4">
                  <div className="text-center p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200/50 transition-all duration-300 hover:shadow-md">
                    <Calendar className="h-5 w-5 text-blue-600 mx-auto mb-1" />
                    <div className="text-xs text-blue-600 font-medium">Year</div>
                    <div className="text-sm font-bold text-gray-900">{car.year}</div>
                  </div>
                  <div className="text-center p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200/50 transition-all duration-300 hover:shadow-md">
                    <Gauge className="h-5 w-5 text-blue-600 mx-auto mb-1" />
                    <div className="text-xs text-blue-600 font-medium">Mileage</div>
                    <div className="text-sm font-bold text-gray-900">{formatMileage(car.milage)}</div>
                  </div>
                  <div className="text-center p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200/50 transition-all duration-300 hover:shadow-md">
    ...
    <Card className="border-blue-200 hover:border-blue-300 transition-all duration-200 hover:shadow-lg bg-white group">
      <CardContent className="p-0">
        <div className="relative">
          ...
          {car.isFeatured && <Badge className="absolute top-3 left-3 bg-yellow-100 text-yellow-800">Featured</Badge>}
        </div>
        <div className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="text-xl font-bold text-blue-600 "><br/>{formatCurrency(car.price)}</div>
          </div>
          ...
          <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white " onClick={()=>{navigate(`/cardetails/${car._id}`)}} >View Details</Button>
        </div>
      </CardContent>
    </Card>
    </Link>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
       ...
       <div className="relative flex-grow">
        ...
        <Input
          ...
          className="pl-10 pr-4 py-3 text-lg border-blue-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full" 
        />
      </div>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* View Toggle */}
            <div className="flex items-center border border-blue-200 rounded-lg p-1">
              <Button
